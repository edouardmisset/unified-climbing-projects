...
import { COEFFICIENT_DISCRETE_HEIGHTS, COEFFICIENT_NUMBER_OF_CRAGS } from '~/ascents/constants'
import { ASCENT_STYLE, type Ascent, HOLDS, PROFILES } from '~/ascents/schema'
