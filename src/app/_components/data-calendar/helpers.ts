...
function getDaysInYear(year: number): number {
  const isLeap = new Date(year, FEBRUARY_MONTH, LEAP_YEAR_TEST_DAY).getMonth() === FEBRUARY_MONTH
 ...
 */
export function groupDataByYear<T extends StringDate>(data: T[]): GroupedData<T> {
