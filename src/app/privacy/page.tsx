...
export default function PrivacyPage() {
  return (
    <article>
      ...
      <p>
        Imported files are parsed in your browser. The original file is not uploaded or logged; only
        confirmed, validated climbing records are sent to the database. Exports are generated in
        your browser.
      </p>
      <p>
