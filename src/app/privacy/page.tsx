    ...
    <PublicPageShell layout="prose">
      <article className={styles.article}>
        ...
        <p>
          ...
          Validated climbing rows are sent securely to the app during preview to identify
          duplicates; only records you confirm are stored. Exports are generated in your browser.
        </p>
        <p>
