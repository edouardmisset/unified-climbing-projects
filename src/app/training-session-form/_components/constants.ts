...
export const energySystemFormattedList = getFormattedList(ENERGY_SYSTEMS, fromEnergySystemToLabel)
export const sessionTypeFormattedList = getFormattedList(SESSION_TYPES, fromSessionTypeToLabel)
