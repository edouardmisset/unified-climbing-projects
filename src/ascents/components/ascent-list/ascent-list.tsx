...
import { MAX_COLUMNS_THRESHOLD } from '~/shared/constants/generic'
import { formatOrdinals } from '~/shared/helpers/format-plurals'
import {
  formatCragAndArea,
  formatHeight,
  formatHolds,
...
import { formatNumber, formatUnit, frenchNumberFormatter } from '~/shared/helpers/number-formatter'
