...
import { DEFAULT_GRADE } from '~/ascents/constants'
import { GRADE_TO_NUMBER, type Grade } from '~/ascents/schema'
...
describe('fromNumberToGrade', () => {
  it('should convert a valid number to its corresponding grade', () => {
    ...
    if (!validNumberKey) throw new Error('No valid number keys found in NUMBER_TO_GRADE')
