...
import { fromSessionTypeToSortOrder } from '~/shared/helpers/sorter'
import {
  fromSessionTypeToBackgroundColor,
  fromSessionTypeToClassName,
} from '~/training/helpers/training-converter'
...
const TrainingPopoverDescription = lazy(async () =>
  import('~/training/components/training-popover-description/training-popover-description').then(
    module => ({
