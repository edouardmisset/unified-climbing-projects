...
import AscentsFilterBar from '~/shared/components/filter-bar/_components/ascents-filter-bar.tsx'
import NotFound from '~/app/not-found.tsx'
import { useAscentsFilter } from '~/ascents/hooks/use-ascents-filter.ts'
import type { AscentListProps } from '~/ascents/schema.ts'
import { DashboardStatistics } from './dashboard-statistics'
import { Loader } from '../ui/loader/loader.tsx'

const AscentList = lazy(() =>
  import('~/ascents/components/ascent-list/ascent-list').then(module => ({
    default: module.AscentList,
  })),
)
