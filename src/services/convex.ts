...
type AscentInsert = Omit<ReturnType<typeof ascentSchema.unwrap>['_output'], '_id'>
type TrainingSessionInsert = Omit<ReturnType<typeof trainingSessionSchema.unwrap>['_output'], '_id'>
 ...
 */
export async function addAscent(ascent: AscentInsert): Promise<void> {
  try {
 ...
 * @throws Error if the database operation fails
 */
export async function addTrainingSession(session: TrainingSessionInsert): Promise<void> {
  try {
