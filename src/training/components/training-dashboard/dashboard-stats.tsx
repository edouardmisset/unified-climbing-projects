...
import styles from '~/shared/components/dashboard/dashboard.module.css'

const TrainingSessionsIndoorVsOutdoor = dynamic(
  () =>
    import('~/shared/components/charts/training-sessions-indoor-vs-outdoor/training-sessions-indoor-vs-outdoor.tsx').then(
...
const TrainingSessionsPerDiscipline = dynamic(
  () =>
    import('~/shared/components/charts/training-sessions-per-discipline/training-sessions-per-discipline.tsx').then(
...
const TrainingSessionsPerYear = dynamic(
  () =>
    import('~/shared/components/charts/training-sessions-per-year/training-sessions-per-year.tsx').then(
...
const TrainingSessionsDistribution = dynamic(
  () =>
    import('~/shared/components/charts/training-sessions-distribution/training-sessions-distribution.tsx').then(
